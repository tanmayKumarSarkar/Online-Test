...
<?php
    ...
    <div class="login_box" id="login_box">
    	...
    	<mmm class="box_header" id="box_header">
			complete Answersheet for Rollno : <?php echo $userid;?>
        </mmm>
...
<div style="width:100px; height:100px;"></div>
    ...
    <div class="side">
        ...
        <p style="margin:5px;">Red bordered boxes are answered by the students.The unanswered or unattempted question have no border.</p>
 ...
 <input type="button" value="Back" onclick="window.location.href='view_result_stud.php?selected_stud=<?php echo $userid;?>';" 
 id="back_button" class="back_button" /> 
</div><br><br><br><br>
